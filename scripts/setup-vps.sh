...
echo "🔄 Restart: pm2 startOrReload ecosystem.config.cjs"
echo ""
echo "📝 Don't forget to:"
echo "   1. Edit ${APP_DIR}/.env with your secrets"
echo "   2. Restart: pm2 startOrReload ecosystem.config.cjs   # environment dibaca dari berkas ini, bukan dari shell"
