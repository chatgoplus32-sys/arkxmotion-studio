...
echo "🔄 Restart: pm2 delete arkxmotion; pm2 start ecosystem.config.cjs"
echo ""
echo "📝 Don't forget to:"
echo "   1. Edit ${APP_DIR}/.env with your secrets"
echo "   2. Restart: pm2 delete arkxmotion; pm2 start ecosystem.config.cjs   # environment dari berkas ini, bukan dari shell"
