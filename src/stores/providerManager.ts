...
export const PROVIDER_CONFIGS: Record<ProviderId, ProviderConfig> = {
  ...
  galleri5: {
    ...
    name: 'G5 AI Studio',
    icon: '🎬',
    description: 'Galleri5 AI Studio — Kling motion control via captured auth headers',
    keyPlaceholder: 'Paste captured headers JSON from Chrome Extension...',
    keyFormat: 'JSON headers from G5 Auth Helper extension',
    minCredits: 0,
    supportsBalance: false,
  },
}
